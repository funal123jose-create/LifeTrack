...
export function CheckinMetricCard({
  ...
  return (
    <div className="min-w-0 rounded-[1.4rem] border border-white/[0.065] bg-slate-950/34 p-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.035)]">
...
export function WeeklySummaryMetricCard({ label, value, helper, Icon }: WeeklySummaryMetricCardProps) {
  return (
    <div className="min-w-0 rounded-[1.35rem] border border-white/[0.065] bg-slate-950/34 p-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.035)]">
      <div className="mb-3 flex items-center justify-between">
